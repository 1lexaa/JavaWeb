...
import step.learning.services.random.RandomServices;
...
public class UserDao
{
    ...
    private final RandomServices _random_services;
    private final KdfService _kdf_service;

    @Inject
    public UserDao(DbProvider db_provider, @Named("db-prefix") String db_prefix, Logger logger,
                   RandomServices random_services, KdfService kdf_service)
    {
